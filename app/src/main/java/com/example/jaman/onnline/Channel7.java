...
public class Channel7 extends AppCompatActivity {
    ...
    String stream =  "http://202.126.122.43:9898/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Channel7.this,Channel8.class);
                startActivity(i);
            }
        });
        ...
        d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Channel7.this,Channel6.class);
                startActivity(i);
            }
        });
        ...
        new Channel7.PlayerTask().execute(stream);
